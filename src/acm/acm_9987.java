package acm;// https://www.acmicpc.net/problem/9987

import java.util.Scanner;

public class acm_9987 {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        int poke_number = sc.nextInt();
        System.out.println(poke_name(poke_number - 1));
        System.out.println(poke_type(poke_number - 1));
    }

    public static String poke_name(int index) {
        String[] name = {
                ...
                "Kangaskhan",                "Horsea",                "Seadra",                "Goldeen",                "Seaking",                "Staryu",                "Starmie",                "Mr. Mime",                "Scyther",                "Jynx",                "Electabuzz",                "Magmar",                "Pinsir",                "Tauros",                "Magikarp",                "Gyarados",                "Lapras",                "Ditto",                "Eevee",                "Vaporeon",                "Jolteon",                "Flareon",                "Porygon",                "Omanyte",                "Omastar",                "Kabuto",                "Kabutops",                "Aerodactyl",                "Snorlax",
    ...
    public static String poke_type(int index) {
